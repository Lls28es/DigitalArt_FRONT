...
import SalesProduct from './SalesProducts/SalesProduct.jsx';
import FilterProductByAuthor from './FilterProductByAuthor.jsx';
import { 
	getAllProducts, 
	addProducts, editProductByBody, 
	editProductCategory, 
	deleteProduct, 
...
function AdminProduct() {
    ...
    return (
		<ReactCardFlip isFlipped={isFlipped} flipDirection="horizontal" id="AdminProduct">
