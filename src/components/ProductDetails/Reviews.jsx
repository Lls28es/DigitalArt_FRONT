...
import ChangeColorStart from '../FunctionStar/ChangeColorStart';
...
function Reviews({ currentUser, productId }) {
	...
	return (
		<div className="review-cont" id="Reviews">
					...
					<div className="contFormReview">
						<form>
							<div className="reviewForm">
								...
								<ChangeColorStart onChange={(value) => setReview({ ...review, score: value })} />
				...
				<div className="add-review">
					...
					<div className="contFormReview">
						<form>
							<div className="reviewForm">
								<span className="spanAddReview">Score</span>
								<ChangeColorStart onChange={(value) => setNewReview({ ...eReview, score: value })} />
								{/* <select
									name="scoreEdit"
